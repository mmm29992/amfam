      ...
      <header className="h-[150px] w-full bg-white flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-between px-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={openModal} // Trigger modal open on Sign In button click
        ...
        <div className="flex-2 flex flex-col justify-center">
          <div className="flex justify-between items-center px-6">
            ...
            <div className="flex space-x-4 items-center">
              {/* Replacing the "Get a Quote" button with "Message Us" */}
              <button className="flex items-center text-white bg-blue-800 hover:bg-blue-700 px-6 py-6 rounded-md font-extrabold">
                <img
                  src="/messageicon.svg" // Replace with your message icon (chat bubble or envelope)
                  alt="Message Icon"
